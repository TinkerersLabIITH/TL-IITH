...
const Contacts = () => {
  return (
    <div className='flex flex-col items-center pt-8'>
      ...
      <div className='flex flex-col xl:flex-row items-center w-full md:px-32 pb-16'>
        <div className="flex flex-col items-center py-8 lg:px-8 w-full ">
        ...
        <div className="border-4  rounded-md border-purple-600 py-4 m-4">
          <div className="contact-form ">
            <form
              ...
              className="contact-inputs flex flex-col px-8 ">
                ...
                <h2 className="text-xl font-bold py-6">Message us</h2>
              ...
              <input type="submit" value="Send" className='border-2 px-4 py-2 bg-purple-600 text-gray-100 font-extrabold rounded-lg' />
            </form>
          </div>
        </div>
      </div>
